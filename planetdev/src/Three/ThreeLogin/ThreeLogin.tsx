...
class ThreeMap extends Component {
    ...
    const init = () => {
        ...
        if((document.getElementById("root") as HTMLElement))
            (document.getElementById("root") as HTMLElement).children[0].children[1].children[1].appendChild(renderer.domElement);
        // this.mount.appendChild( renderer.domElement ); // mount using React ref
